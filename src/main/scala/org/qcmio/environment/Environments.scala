...
import org.qcmio.environment.repository.usersRepository.UserRepository
...
object Environments {
  ...
  val userRepositoryLayer: TaskLayer[Has[usersRepository.UserRepository]] = dbDataSourceLayer >>> usersRepository.layer
